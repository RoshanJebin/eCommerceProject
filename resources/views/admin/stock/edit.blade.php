        ...
        <div class="card">
            <div class="card-body">
                ...
                <form action="{{ route('stocks.update', $stock->id) }}" method="post" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    <input type="hidden" name="id" value="{{ $stock->id }}" id="id">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="supplier_name" id="supplier_name"
                            placeholder="Supplier Name" value="{{ old('supplier_name', $stock->supplier_name) }}">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="date" class="form-control" name="last_added_date" id="last_added_date"
                            placeholder="Last added date" value="{{ old('last_added_date', $stock->last_added_date) }}">
                    </div>
